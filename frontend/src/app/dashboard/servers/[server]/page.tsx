...
export default function ServerConfig() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gray-900/60 backdrop-blur-md rounded-2xl border border-gray-700/40 p-6 animate-fade-in-up stagger-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="bg-gray-800/40 rounded-xl p-3 border border-gray-700/30 transition-colors hover:border-gray-600/50">
