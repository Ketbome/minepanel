...
export const es: Record<TranslationKey, string> = {
  ...
  monitoringDescription: "Rendimiento del juego y recursos del contenedor. Monitorización nativa de NeoForge para packs CurseForge como ATM10; spark cuando esté disponible.",
  ...
  monitoringSetup: "En ATM10 / NeoForge, comprueba que el pack incluye spark. Si falta, instala el mod de servidor compatible con la versión y el cargador y reinicia.",
