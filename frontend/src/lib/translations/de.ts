...
export const de: Record<TranslationKey, string> = {
  ...
  worldDiscoverDescription: 'Suche Welten auf CurseForge oder importiere sie direkt per ZIP/TAR-URL in die World Library.',
  ...
  worldDiscoverImported: 'Welt in die World Library importiert',
