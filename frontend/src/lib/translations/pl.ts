...
export const pl: Record<TranslationKey, string> = {
  ...
  monitoringDescription: "Wydajność gry i zasoby kontenera. Natywne monitorowanie NeoForge dla paczek CurseForge, takich jak ATM10; spark, gdy dostępny.",
  ...
  monitoringSetup: "Dla ATM10 / NeoForge sprawdź, czy paczka zawiera spark. Jeśli nie, zainstaluj mod serwerowy zgodny z wersją Minecraft i loaderem, a następnie uruchom serwer ponownie.",
