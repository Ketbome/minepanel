...
export const es: Record<TranslationKey, string> = {
  ...
  monitoringRconDisabled: "Activa RCON en los ajustes de red del servidor y reinicia.",
  ...
  monitoringSetup: "En packs basados en NeoForge, comprueba que el pack incluye spark. Si falta, instala el mod de servidor compatible con la versión y el cargador y reinicia.",
