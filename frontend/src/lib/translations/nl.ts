...
export const nl: Record<TranslationKey, string> = {
  ...
  monitoringDescription: "Spelprestaties en containerbronnen. Native NeoForge-monitoring voor CurseForge-modpacks zoals ATM10; spark waar beschikbaar.",
  ...
  monitoringSetup: "Controleer bij ATM10 / NeoForge of het pack spark bevat. Installeer zo nodig de servermod voor de juiste Minecraft-versie en loader en herstart.",
