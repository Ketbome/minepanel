...
export const nl: Record<TranslationKey, string> = {
  ...
  paPrevious: "Vorige",
  paNext: "Volgende",
  paFirstSeen: "Eerst gezien",
  paLastSeen: "Laatst gezien",
  paRecordedTime: "Geregistreerde speeltijd",
  paSessions: "Sessies",
  paIdentityNote: "Java-geschiedenis volgt de spelersnaam; Bedrock-geschiedenis volgt de XUID.",
  paSavedStats: "Opgeslagen wereldstatistieken",
  paUpdated: "Bijgewerkt",
  paWorldTime: "Speeltijd in de wereld",
  paDeaths: "Sterfgevallen",
  paMobKills: "Gedode wezens",
  paPlayerKills: "Gedode spelers",
  paBlocksMined: "Gedolven blokken",
  paStatsNote: "Wereldtotalen komen uit de laatste opslag en staan los van de sessietijd in het paneel.",
  paStatsUnavailable: "Statistieken niet beschikbaar. Java-wereldstatistieken en een passende spelercache zijn vereist.",
  paJoined: "Binnenkomst",
  paLeft: "Vertrek / laatste waarneming",
  paDuration: "Duur (u:mm:ss)",
  paStatus: "Status",
  paInterrupted: "Onderbroken",
  paCompleted: "Voltooid",
  paActive: "Actief",
  paUnknown: "Onbekend",
  paDescription: "Spelersprofielen en sessiegeschiedenis, inclusief offline spelers.",
  paTrackingNote: "Elke 30 seconden bijgewerkt vanuit serverlogs. Bij de eerste start worden maximaal 24 uur aan beschikbare logs gelezen. Ontbrekende logs kunnen gaten geven; geregistreerde tijd is niet de totale historische speeltijd.",
  paUnavailable: "Registratie niet beschikbaar of verouderd. Online status onbekend.",
  paError: "Spelersactiviteit laden mislukt. Automatisch opnieuw proberen.",
  paPlayer: "Speler",
  paOnline: "Online",
  paOffline: "Offline",
  paEmpty: "Nog geen sessies. Spelers verschijnen na een geregistreerde binnenkomst.",
  ...
  dangerEggButtonAgain: 'Niet indrukken. Alweer.',
  dangerEggIntro: 'Je kreeg te horen dat je er niet op mocht drukken.',
  dangerEggEndTagline: 'Of het begin?',
  dangerEggGoalReached: 'Doel bereikt!',
  dangerEggAdvEyeSpy: 'Ik zie, ik zie',
  dangerEggAdvEnterEnd: 'Het einde?',
  dangerEggAdvFreeEnd: 'Bevrijd de End',
  dangerEggAdvNextGen: 'De volgende generatie',
  dangerEggChatAdvancement: '{player} heeft de vooruitgang geboekt',
  dangerEggChatGoal: '{player} heeft het doel bereikt',
  dangerEggPlayer: 'Speler',
  dangerEggBossName: 'Enderdraak',
  dangerEggObjectives: 'Doelen',
  dangerEggObjCrystals: 'Vernietig de Endkristallen',
  dangerEggObjDragon: 'Versla de Enderdraak',
  dangerEggObjEgg: 'Vang het drakenei',
  dangerEggObjPortal: 'Spring in het uitgangsportaal',
  dangerEggHintCrystals: 'Breek de Endkristallen op de pilaren. Sleep om rond te kijken.',
  dangerEggHintHealing: 'De kristallen genezen hem. Breek ze eerst.',
  dangerEggHintPerch: 'De draak hangt boven het portaal. Sla nu toe!',
  dangerEggHintEnderman: 'Kijk ze niet in de ogen.',
  dangerEggHintEgg: 'Het ei is weggeteleporteerd. Probeer het opnieuw.',
  dangerEggHintPortal: 'Het uitgangsportaal is open.',
  dangerEggSubEye: 'Enderoog geplaatst',
  dangerEggSubPortal: 'Endportaal opent',
  dangerEggSubTravel: 'Portaal zoemt',
  dangerEggSubLava: 'Lava borrelt',
  dangerEggSubGrowl: 'Enderdraak gromt',
  dangerEggSubHurt: 'Enderdraak gewond',
  dangerEggSubDeath: 'Enderdraak sterft',
  dangerEggSubCrystal: 'Endkristal ontploft',
  dangerEggSubEnderman: 'Enderman teleporteert',
  dangerEggSubEgg: 'Drakenei teleporteert',
  dangerEggSubXp: 'Ervaringsbol rinkelt',
  dangerEggSubGateway: 'Endpoort verschijnt',
  dangerEggMute: 'Geluid uit',
  dangerEggUnmute: 'Geluid aan',
  dangerEggSkip: 'Overslaan',
  dangerEggPoem: 'Ik zie de speler die je bedoelt.\n{player}?\nJa. Pas op. Hij heeft nu een hoger niveau bereikt. Hij kan onze gedachten lezen.\nDat maakt niet uit. Hij denkt dat wij deel van het spel zijn.\nIk mag deze speler. Hij speelde goed. Hij gaf niet op.\nHem werd gezegd dat hij niet op de knop moest drukken.\nHij drukte er toch op. Dat doen ze altijd. Zo vinden ze ons.\nHij houdt werelden draaiende voor anderen. Hij leest hun logs terwijl zij slapen.\nHij herstart wat kapotgaat. Hij bewaart wat ertoe doet. Hij heeft nooit om een bedankje gevraagd.\nWaar droomde deze speler van?\nDeze speler droomde van zonlicht en bomen. Van vuur en water. Hij droomde dat hij schiep. En hij droomde dat hij vernietigde. Hij droomde dat hij jaagde, en werd opgejaagd. Hij droomde van beschutting.\nEn het universum zei: je bent niet alleen\nEn het universum zei: je bent niet gescheiden van al het andere\nEn het universum zei: jij bent het universum dat zichzelf proeft, tegen zichzelf praat, zijn eigen code leest\nEn het universum zei: ik hou van je, omdat jij liefde bent.\nEn het spel was voorbij en de speler ontwaakte uit de droom. En de speler begon een nieuwe droom. En de speler droomde opnieuw, droomde beter. En de speler was het universum. En de speler was liefde.\nJij bent de speler.\nWord wakker.',
  dangerEggPoemCredit: 'Endgedicht van Julian Gough (CC0), ingekort. Vier regels zijn voor Minepanel geschreven.',
  dangerEggPoemHint: 'Houd spatie of je vinger ingedrukt om te versnellen',
  ...
  playersTabDesc: 'Iedereen die op deze server is geweest: statistieken, advancements en inventaris, gelezen uit de wereldbestanden.',
  filterAll: 'Alle',
  noPlayersFound: 'Geen spelers gevonden',
  playerNoDataYet: 'Online, nog geen opgeslagen gegevens',
  playersLoadError: 'Spelers konden niet worden geladen',
  selectPlayer: 'Kies een speler om het profiel te zien',
  addToWhitelist: 'Toevoegen aan whitelist',
  removeFromWhitelist: 'Verwijderen uit whitelist',
  banned: 'Verbannen',
  profile: 'Profiel',
  ...
  itemDurability: 'Duurzaamheid',
  playerHealth: 'Leven',
  playerHunger: 'Honger',
  activeEffects: 'Actieve effecten',
  noActiveEffects: 'Geen actieve effecten',
  playTime: 'Speeltijd',
  deaths: 'Doden',
  mobKills: 'Mobs gedood',
  playerKills: 'PvP-kills',
  distanceTraveled: 'Afstand',
  blocksMined: 'Blokken gedolven',
  lastSeen: 'Laatst gezien',
  never: 'Nooit',
  lastPosition: 'Laatste positie',
  spawnPoint: 'Spawnpunt',
  playerDataSavedNote: 'Minecraft schrijft spelergegevens bij autosave en uitloggen, dus online spelers kunnen een paar minuten achterlopen.',
  noStats: 'Geen statistieken in deze categorie',
  noAdvancements: 'Nog geen advancements',
  activity: 'Activiteit',
  activityTabDesc: 'Joins, vertrekken, chat, doden, advancements en commando\'s uit het serverlog, doorzoekbaar.',
  activityTracking: 'Activiteit bijhouden',
  activityTrackingDesc: 'Leest het serverlog om sessies en een doorzoekbare tijdlijn bij te houden, inclusief chat. Standaard uit; 30 dagen bewaard.',
  activityDisabled: 'Activiteit bijhouden staat uit voor deze server. Zet het aan om vanaf nu te registreren.',
  activityLoadError: 'Activiteit kon niet worden geladen',
  noActivity: 'Nog geen activiteit geregistreerd',
  importHistory: 'Geschiedenis importeren',
  importHistoryDesc: 'Leest de gearchiveerde logs van vóór het aanzetten (datums komen uit de archiefnamen).',
  historyImported: 'Gebeurtenissen geïmporteerd',
  eventJoin: 'Joined',
  eventLeave: 'Vertrokken',
  eventChat: 'Chat',
  eventDeath: 'Dood',
  eventAdvancement: 'Advancement',
  eventCommand: 'Commando',
  sessions: 'Sessies',
  noSessions: 'Geen sessies geregistreerd. Zet activiteit bijhouden aan in het tabblad Activiteit.',
  totalSessions: 'Sessies',
  averageSession: 'Gemiddelde sessie',
  longestSession: 'Langste sessie',
  playStreak: 'Dagen op rij',
  playByWeekday: 'Speeltijd per weekdag',
  sessionStart: 'Start',
  duration: 'Duur',
  chatMessages: 'Chat',
  findItem: 'Zoek een item (bijv. diamond, een hernoemd zwaard)…',
  findItemDesc: 'Doorzoekt de opgeslagen inventaris, enderkist en de shulkerdozen en bundels van elke speler',
  noItemMatches: 'Niemand heeft dat item in de opgeslagen inventaris',
  inside: 'in',
  currentInventory: 'Huidig',
  autosave: 'Autosave',
  beforeDeath: 'voor overlijden',
  snapshotBeforeDeath: 'Laatste momentopname voor overlijden',
  changesSincePrevious: 'Wijzigingen sinds de vorige momentopname',
  noSnapshots: 'Nog geen momentopnamen (vereist activiteit bijhouden)',
  ...
  tasks: 'Taken',
  monitoringEstimatedTps: "Geschatte TPS",
  monitoringNativeHelp: "NeoForge schat TPS uit de gemiddelde tickduur, niet uit een gemeten tickaantal.",
  monitoringMeanHelp: "Gemiddelde duur van recente NeoForge-ticks",
  monitoringTitle: "Servermonitoring",
  monitoringDescription: "Spelprestaties en containerbronnen. Native NeoForge-monitoring voor CurseForge-modpacks; spark waar beschikbaar.",
  monitoringCadence: "Live: elke 10 seconden · Geschiedenis: elke minuut, 7 dagen bewaard",
  monitoringTpsWindow: "Gemiddelde over 1 minuut · Standaarddoel: 20",
  monitoringMsptWindow: "Mediaan over 10 seconden",
  monitoringCpuHelp: "Container-CPU · 100% = één volledig gebruikte kern",
  monitoringMemoryHelp: "Containergeheugen, inclusief Java en native toewijzingen",
  monitoringConnected: "Tickmetingen beschikbaar",
  monitoringOffline: "Server offline of wordt gestart. Geen tickmetingen beschikbaar.",
  monitoringUnsupported: "Tickmonitoring wordt niet ondersteund op Bedrock. Bronmetingen blijven beschikbaar.",
  monitoringRconDisabled: "Schakel RCON in op het tabblad Toegang van de server en herstart om tickmetingen te verzamelen.",
  monitoringSparkMissing: "Het spark-commando is niet beschikbaar op deze server.",
  monitoringUnavailable: "Geen bruikbaar spark-antwoord. De server start mogelijk nog; controleer RCON en spark in de console.",
  monitoringSource: "Tickmonitoring",
  monitoringTickHelp: "Bij 20 TPS heeft elke tick 50 ms. P95 is de duur waaronder 95% van de gemeten ticks valt.",
  monitoringSetup: "Tickmetingen op deze server vereisen spark. Installeer de spark-servermod of -plugin voor de juiste Minecraft-versie en loader en herstart.",
  monitoringSparkDocs: "spark-installatiegids",
  monitoringHistory: "Prestatiegeschiedenis",
  monitoringRange: "Periode",
  monitoringFetchError: "Live monitoring kon niet worden geladen. Waarden verschijnen na de volgende geslaagde vernieuwing.",
  monitoringHistoryError: "Geschiedenis kon niet worden vernieuwd. Eerdere metingen kunnen verouderd zijn.",
  monitoringP95Help: "95e percentiel over 10 seconden · Referentie: 50 ms bij 20 TPS",
  monitoringPlayersHelp: "Online spelers per meting",
  monitoringLatest: "Laatste meting",
  monitoringMinimum: "Minimum",
  monitoringMaximum: "Maximum",
  monitoringReference: "Referentie",
