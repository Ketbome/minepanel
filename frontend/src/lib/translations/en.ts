export const en = {
  ...
  monitoringRconDisabled: "Enable RCON in the server network settings, then restart to collect tick measurements.",
  ...
  monitoringSetup: "For NeoForge-based modpacks, check that the pack includes spark. If missing, install a server mod matching the Minecraft version and loader, then restart.",
