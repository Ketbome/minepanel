export const en = {
  ...
  paPrevious: "Previous",
  paNext: "Next",
  paFirstSeen: "First seen",
  paLastSeen: "Last seen",
  paRecordedTime: "Recorded playtime",
  paSessions: "Sessions",
  paIdentityNote: "Java history follows the player name; Bedrock history follows the XUID.",
  paSavedStats: "Saved world statistics",
  paUpdated: "Updated",
  paWorldTime: "World playtime",
  paDeaths: "Deaths",
  paMobKills: "Mob kills",
  paPlayerKills: "Player kills",
  paBlocksMined: "Blocks mined",
  paStatsNote: "World totals come from the last Minecraft save and are separate from panel session time.",
  paStatsUnavailable: "Statistics unavailable. Requires Java world statistics and a matching user cache entry.",
  paJoined: "Joined",
  paLeft: "Left / last observation",
  paDuration: "Duration (h:mm:ss)",
  paStatus: "Status",
  paInterrupted: "Interrupted",
  paCompleted: "Completed",
  paActive: "Active",
  paUnknown: "Unknown",
  paDescription: "Player profiles and session history, including offline players.",
  paTrackingNote: "Updates every 30 seconds from server join/leave logs. First activation reads up to 24 hours of retained logs. Missing logs and interruptions can leave gaps; recorded time is not lifetime playtime.",
  paUnavailable: "Tracking is unavailable or stale. Online status is unknown.",
  paError: "Could not load player activity. Retrying automatically.",
  paPlayer: "Player",
  paOnline: "Online",
  paOffline: "Offline",
  paEmpty: "No recorded sessions yet. Players appear after a recorded join event.",
  ...
  dangerEggButtonAgain: 'Do not press. Again.',
  dangerEggIntro: 'You were told not to press it.',
  dangerEggEndTagline: 'Or the beginning?',
  dangerEggGoalReached: 'Goal Reached!',
  dangerEggAdvEyeSpy: 'Eye Spy',
  dangerEggAdvEnterEnd: 'The End?',
  dangerEggAdvFreeEnd: 'Free the End',
  dangerEggAdvNextGen: 'The Next Generation',
  dangerEggChatAdvancement: '{player} has made the advancement',
  dangerEggChatGoal: '{player} has reached the goal',
  dangerEggPlayer: 'Player',
  dangerEggBossName: 'Ender Dragon',
  dangerEggObjectives: 'Objectives',
  dangerEggObjCrystals: 'Destroy the End Crystals',
  dangerEggObjDragon: 'Slay the Ender Dragon',
  dangerEggObjEgg: 'Catch the Dragon Egg',
  dangerEggObjPortal: 'Jump into the exit portal',
  dangerEggHintCrystals: 'Break the End Crystals on the pillars. Drag to look around.',
  dangerEggHintHealing: 'The crystals are healing it. Break them first.',
  dangerEggHintPerch: 'The dragon is over the portal. Strike now!',
  dangerEggHintEnderman: "Don't look them in the eyes.",
  dangerEggHintEgg: 'The egg teleported away. Try again.',
  dangerEggHintPortal: 'The exit portal is open.',
  dangerEggSubEye: 'Eye of Ender attaches',
  dangerEggSubPortal: 'End Portal opens',
  dangerEggSubTravel: 'Portal whooshes',
  dangerEggSubLava: 'Lava pops',
  dangerEggSubGrowl: 'Ender Dragon growls',
  dangerEggSubHurt: 'Ender Dragon hurts',
  dangerEggSubDeath: 'Ender Dragon dies',
  dangerEggSubCrystal: 'End Crystal explodes',
  dangerEggSubEnderman: 'Enderman teleports',
  dangerEggSubEgg: 'Dragon Egg teleports',
  dangerEggSubXp: 'Experience Orb tinkles',
  dangerEggSubGateway: 'End Gateway spawns',
  dangerEggMute: 'Mute sound',
  dangerEggUnmute: 'Unmute sound',
  dangerEggSkip: 'Skip',
  dangerEggPoem: "I see the player you mean.\n{player}?\nYes. Take care. It has reached a higher level now. It can read our thoughts.\nThat doesn't matter. It thinks we are part of the game.\nI like this player. It played well. It did not give up.\nIt was told not to press the button.\nIt pressed it anyway. They always do. That is how they find us.\nIt keeps worlds running for others. It reads their logs while they sleep.\nIt restarts what breaks. It keeps what matters. It never asked to be thanked.\nWhat did this player dream?\nThis player dreamed of sunlight and trees. Of fire and water. It dreamed it created. And it dreamed it destroyed. It dreamed it hunted, and was hunted. It dreamed of shelter.\nAnd the universe said you are not alone\nAnd the universe said you are not separate from every other thing\nAnd the universe said you are the universe tasting itself, talking to itself, reading its own code\nAnd the universe said I love you because you are love.\nAnd the game was over and the player woke up from the dream. And the player began a new dream. And the player dreamed again, dreamed better. And the player was the universe. And the player was love.\nYou are the player.\nWake up.",
  dangerEggPoemCredit: 'End Poem by Julian Gough (CC0), abridged. Four lines were written for Minepanel.',
  dangerEggPoemHint: 'Hold Space, or press and hold, to speed up',
  ...
  playersTabDesc: 'Everyone who has joined this server: stats, advancements and inventory, read from the world files.',
  filterAll: 'All',
  noPlayersFound: 'No players found',
  playerNoDataYet: 'Online, no saved data yet',
  playersLoadError: 'Could not load players',
  selectPlayer: 'Select a player to see their profile',
  ...
  playerDataSavedNote: 'Minecraft writes player data on autosave and logout, so online players can be a few minutes behind.',
  noStats: 'No statistics in this category',
  noAdvancements: 'No advancements yet',
  activity: 'Activity',
  activityTabDesc: 'Joins, leaves, chat, deaths, advancements and commands from the server log, searchable.',
  activityTracking: 'Track activity',
  activityTrackingDesc: 'Reads the server log to keep sessions and a searchable timeline, including chat. Off by default; kept for 30 days.',
  activityDisabled: 'Activity tracking is off for this server. Turn it on to start recording from now.',
  activityLoadError: 'Could not load activity',
  noActivity: 'No activity recorded yet',
  importHistory: 'Import history',
  importHistoryDesc: 'Read the archived logs from before tracking was turned on (dates come from the archive names).',
  historyImported: 'Events imported',
  eventJoin: 'Joined',
  eventLeave: 'Left',
  eventChat: 'Chat',
  eventDeath: 'Death',
  ...
  sessions: 'Sessions',
  noSessions: 'No sessions recorded. Turn on activity tracking in the Activity tab.',
  totalSessions: 'Sessions',
  averageSession: 'Average session',
  longestSession: 'Longest session',
  playStreak: 'Day streak',
  playByWeekday: 'Play time by weekday',
  sessionStart: 'Start',
  duration: 'Duration',
  chatMessages: 'Chat',
  findItem: 'Find an item (e.g. diamond, a renamed sword)…',
  findItemDesc: 'Searches every player\'s saved inventory, ender chest and the shulker boxes and bundles they carry',
  noItemMatches: 'Nobody has that item in their saved inventory',
  inside: 'inside',
  currentInventory: 'Current',
  autosave: 'Autosave',
  beforeDeath: 'before death',
  snapshotBeforeDeath: 'Last snapshot before death',
  changesSincePrevious: 'Changes since the previous snapshot',
  noSnapshots: 'No snapshots yet (needs activity tracking)',
  ...
  metrics: 'Metrics',
  tasks: 'Tasks',
  monitoringEstimatedTps: "Estimated TPS",
  monitoringNativeHelp: "NeoForge TPS is estimated from mean tick time, not a measured tick count.",
  monitoringMeanHelp: "Mean tick duration from NeoForge’s recent tick buffer",
  monitoringTitle: "Server monitoring",
  monitoringDescription: "Game performance and container resources, together. Native NeoForge monitoring for CurseForge modpacks; spark where available.",
  monitoringCadence: "Live: every 10 seconds · History: every minute, kept for 7 days",
  monitoringTpsWindow: "1-minute average · Default target: 20",
  monitoringMsptWindow: "Median over 10 seconds",
  monitoringCpuHelp: "Container CPU · 100% = one fully used core",
  monitoringMemoryHelp: "Container memory, including Java and native allocations",
  monitoringConnected: "Tick measurements available",
  monitoringOffline: "Server offline or starting. Tick measurements are unavailable.",
  monitoringUnsupported: "Tick monitoring is not supported on Bedrock. Resource monitoring remains available.",
  monitoringRconDisabled: "Enable RCON in the server's Access tab, then restart to collect tick measurements.",
  monitoringSparkMissing: "The spark command is not available on this server.",
  monitoringUnavailable: "No usable spark response. The server may still be starting; check RCON and spark in the console.",
  monitoringSource: "Tick monitoring",
  monitoringTickHelp: "At the default 20 TPS, ticks have a 50 ms budget. P95 shows the duration below which 95% of measured ticks fall.",
  monitoringSetup: "Tick measurements on this server require spark. Install the spark server mod or plugin matching the Minecraft version and loader, then restart.",
  monitoringSparkDocs: "spark setup guide",
  monitoringHistory: "Performance history",
  monitoringRange: "Time range",
  monitoringFetchError: "Live monitoring could not be loaded. Values are unavailable until the next successful refresh.",
  monitoringHistoryError: "History could not be refreshed. Previously loaded samples may be out of date.",
  monitoringP95Help: "95th percentile tick duration over 10 seconds · Reference: 50 ms at 20 TPS",
  monitoringPlayersHelp: "Online players at each sample",
  monitoringLatest: "Latest sample",
  monitoringMinimum: "Minimum",
  monitoringMaximum: "Maximum",
  monitoringReference: "Reference",
