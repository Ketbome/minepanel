...
export const de: Record<TranslationKey, string> = {
  ...
  paPrevious: "Zurück",
  paNext: "Weiter",
  paFirstSeen: "Erstmals gesehen",
  paLastSeen: "Zuletzt gesehen",
  paRecordedTime: "Erfasste Spielzeit",
  paSessions: "Sitzungen",
  paIdentityNote: "Java-Verläufe folgen dem Spielernamen; Bedrock-Verläufe der XUID.",
  paSavedStats: "Gespeicherte Weltstatistiken",
  paUpdated: "Aktualisiert",
  paWorldTime: "Spielzeit in der Welt",
  paDeaths: "Tode",
  paMobKills: "Getötete Kreaturen",
  paPlayerKills: "Getötete Spieler",
  paBlocksMined: "Abgebaute Blöcke",
  paStatsNote: "Weltwerte stammen aus dem letzten Spielstand und sind von der Sitzungszeit im Panel getrennt.",
  paStatsUnavailable: "Statistiken nicht verfügbar. Java-Weltstatistiken und ein passender Spielercache-Eintrag sind erforderlich.",
  paJoined: "Beitritt",
  paLeft: "Austritt / letzte Beobachtung",
  paDuration: "Dauer (h:mm:ss)",
  paStatus: "Status",
  paInterrupted: "Unterbrochen",
  paCompleted: "Abgeschlossen",
  paActive: "Aktiv",
  paUnknown: "Unbekannt",
  paDescription: "Spielerprofile und Sitzungsverlauf, auch für Spieler, die offline sind.",
  paTrackingNote: "Aktualisierung alle 30 Sekunden aus Beitritts-/Austrittslogs. Beim ersten Start werden bis zu 24 Stunden vorhandener Logs gelesen. Fehlende Logs können Lücken verursachen; erfasste Zeit ist nicht die gesamte bisherige Spielzeit.",
  paUnavailable: "Erfassung nicht verfügbar oder veraltet. Online-Status unbekannt.",
  paError: "Spieleraktivität konnte nicht geladen werden. Automatischer neuer Versuch.",
  paPlayer: "Spieler",
  paOnline: "Online",
  paOffline: "Offline",
  paEmpty: "Noch keine Sitzungen. Spieler erscheinen nach einem erfassten Beitritt.",
  ...
  dangerEggButtonAgain: 'Nicht drücken. Schon wieder.',
  dangerEggIntro: 'Man hat dir gesagt, du sollst ihn nicht drücken.',
  dangerEggEndTagline: 'Oder der Anfang?',
  dangerEggGoalReached: 'Ziel erreicht!',
  dangerEggAdvEyeSpy: 'Adlerauge',
  dangerEggAdvEnterEnd: 'Das Ende?',
  dangerEggAdvFreeEnd: 'Befreie das Ende',
  dangerEggAdvNextGen: 'Die nächste Generation',
  dangerEggChatAdvancement: '{player} hat den Fortschritt erzielt',
  dangerEggChatGoal: '{player} hat das Ziel erreicht',
  dangerEggPlayer: 'Spieler',
  dangerEggBossName: 'Enderdrache',
  dangerEggObjectives: 'Ziele',
  dangerEggObjCrystals: 'Zerstöre die Endkristalle',
  dangerEggObjDragon: 'Besiege den Enderdrachen',
  dangerEggObjEgg: 'Fange das Drachenei',
  dangerEggObjPortal: 'Spring ins Ausgangsportal',
  dangerEggHintCrystals: 'Zerstöre die Endkristalle auf den Säulen. Ziehen, um dich umzusehen.',
  dangerEggHintHealing: 'Die Kristalle heilen ihn. Zerstöre sie zuerst.',
  dangerEggHintPerch: 'Der Drache schwebt über dem Portal. Schlag jetzt zu!',
  dangerEggHintEnderman: 'Schau ihnen nicht in die Augen.',
  dangerEggHintEgg: 'Das Ei hat sich wegteleportiert. Versuch es noch mal.',
  dangerEggHintPortal: 'Das Ausgangsportal ist offen.',
  dangerEggSubEye: 'Enderauge eingesetzt',
  dangerEggSubPortal: 'Endportal öffnet sich',
  dangerEggSubTravel: 'Portal rauscht',
  dangerEggSubLava: 'Lava blubbert',
  dangerEggSubGrowl: 'Enderdrache knurrt',
  dangerEggSubHurt: 'Enderdrache verletzt',
  dangerEggSubDeath: 'Enderdrache stirbt',
  dangerEggSubCrystal: 'Endkristall explodiert',
  dangerEggSubEnderman: 'Enderman teleportiert sich',
  dangerEggSubEgg: 'Drachenei teleportiert sich',
  dangerEggSubXp: 'Erfahrungskugel klingt',
  dangerEggSubGateway: 'Endtransitportal entsteht',
  dangerEggMute: 'Ton aus',
  dangerEggUnmute: 'Ton an',
  dangerEggSkip: 'Überspringen',
  dangerEggPoem: 'Ich sehe den Spieler, den du meinst.\n{player}?\nJa. Sei vorsichtig. Er hat jetzt eine höhere Stufe erreicht. Er kann unsere Gedanken lesen.\nDas spielt keine Rolle. Er glaubt, wir seien Teil des Spiels.\nIch mag diesen Spieler. Er hat gut gespielt. Er hat nicht aufgegeben.\nMan sagte ihm, er solle den Knopf nicht drücken.\nEr hat ihn trotzdem gedrückt. Das tun sie immer. So finden sie uns.\nEr hält Welten für andere am Laufen. Er liest ihre Logs, während sie schlafen.\nEr startet neu, was kaputtgeht. Er bewahrt, was zählt. Er hat nie um Dank gebeten.\nWovon hat dieser Spieler geträumt?\nDieser Spieler träumte von Sonnenlicht und Bäumen. Von Feuer und Wasser. Er träumte, er erschaffe. Und er träumte, er zerstöre. Er träumte, er jage und werde gejagt. Er träumte von Zuflucht.\nUnd das Universum sagte: Du bist nicht allein\nUnd das Universum sagte: Du bist nicht getrennt von allem anderen\nUnd das Universum sagte: Du bist das Universum, das sich selbst schmeckt, mit sich selbst spricht, seinen eigenen Code liest\nUnd das Universum sagte: Ich liebe dich, weil du Liebe bist.\nUnd das Spiel war vorbei, und der Spieler erwachte aus dem Traum. Und der Spieler begann einen neuen Traum. Und der Spieler träumte wieder, träumte besser. Und der Spieler war das Universum. Und der Spieler war Liebe.\nDu bist der Spieler.\nWach auf.',
  dangerEggPoemCredit: 'Endgedicht von Julian Gough (CC0), gekürzt. Vier Zeilen wurden für Minepanel geschrieben.',
  dangerEggPoemHint: 'Leertaste oder gedrückt halten zum Beschleunigen',
  ...
  emailChangeNeedsSmtp: 'Zum Ändern der E-Mail wird SMTP zur Bestätigung benötigt. Bitte einen Admin, sie zu ändern.',
  ...
  playersTabDesc: 'Alle, die diesen Server betreten haben: Statistiken, Fortschritte und Inventar, gelesen aus den Weltdateien.',
  filterAll: 'Alle',
  noPlayersFound: 'Keine Spieler gefunden',
  playerNoDataYet: 'Online, noch keine gespeicherten Daten',
  playersLoadError: 'Spieler konnten nicht geladen werden',
  selectPlayer: 'Wähle einen Spieler, um sein Profil zu sehen',
  ...
  playTime: 'Spielzeit',
  deaths: 'Tode',
  mobKills: 'Getötete Mobs',
  playerKills: 'PvP-Kills',
  distanceTraveled: 'Distanz',
  blocksMined: 'Abgebaute Blöcke',
  lastSeen: 'Zuletzt gesehen',
  never: 'Nie',
  lastPosition: 'Letzte Position',
  spawnPoint: 'Spawnpunkt',
  playerDataSavedNote: 'Minecraft speichert Spielerdaten beim Autosave und beim Ausloggen, daher können Online-Spieler einige Minuten hinterherhinken.',
  noStats: 'Keine Statistiken in dieser Kategorie',
  noAdvancements: 'Noch keine Fortschritte',
  activity: 'Aktivität',
  activityTabDesc: 'Beitritte, Austritte, Chat, Tode, Fortschritte und Befehle aus dem Serverlog, durchsuchbar.',
  activityTracking: 'Aktivität aufzeichnen',
  activityTrackingDesc: 'Liest das Serverlog, um Sitzungen und eine durchsuchbare Zeitleiste inklusive Chat zu speichern. Standardmäßig aus; 30 Tage aufbewahrt.',
  activityDisabled: 'Die Aktivitätsaufzeichnung ist für diesen Server aus. Schalte sie ein, um ab jetzt aufzuzeichnen.',
  ...
  importHistoryDesc: 'Liest die archivierten Logs von vor dem Einschalten (Daten stammen aus den Archivnamen).',
  historyImported: 'Ereignisse importiert',
  eventJoin: 'Beigetreten',
  eventLeave: 'Verlassen',
  eventChat: 'Chat',
  eventDeath: 'Tod',
  eventAdvancement: 'Fortschritt',
  eventCommand: 'Befehl',
  sessions: 'Sitzungen',
  noSessions: 'Keine Sitzungen aufgezeichnet. Schalte die Aktivitätsaufzeichnung im Tab Aktivität ein.',
  totalSessions: 'Sitzungen',
  averageSession: 'Durchschnittliche Sitzung',
  longestSession: 'Längste Sitzung',
  playStreak: 'Tage in Folge',
  playByWeekday: 'Spielzeit pro Wochentag',
  sessionStart: 'Start',
  duration: 'Dauer',
  chatMessages: 'Chat',
  findItem: 'Item suchen (z. B. diamond, ein umbenanntes Schwert)…',
  findItemDesc: 'Durchsucht das gespeicherte Inventar, die Endertruhe und mitgeführte Shulkerkisten und Bündel jedes Spielers',
  noItemMatches: 'Niemand hat dieses Item im gespeicherten Inventar',
  inside: 'in',
  currentInventory: 'Aktuell',
  autosave: 'Autosave',
  beforeDeath: 'vor dem Tod',
  snapshotBeforeDeath: 'Letzter Stand vor dem Tod',
  changesSincePrevious: 'Änderungen seit dem vorherigen Stand',
  noSnapshots: 'Noch keine Stände (Aktivitätsaufzeichnung nötig)',
  ...
  metrics: 'Metriken',
  tasks: 'Aufgaben',
  monitoringEstimatedTps: "Geschätzte TPS",
  monitoringNativeHelp: "NeoForge schätzt TPS aus der mittleren Tick-Dauer, statt Ticks zu zählen.",
  monitoringMeanHelp: "Mittlere Dauer aus NeoForges letzten Ticks",
  monitoringTitle: "Serverüberwachung",
  monitoringDescription: "Spielleistung und Containerressourcen. Native NeoForge-Überwachung für CurseForge-Modpacks; spark, sofern verfügbar.",
  monitoringCadence: "Live: alle 10 Sekunden · Verlauf: jede Minute, 7 Tage gespeichert",
  monitoringTpsWindow: "1-Minuten-Mittelwert · Standardziel: 20",
  monitoringMsptWindow: "Median über 10 Sekunden",
  monitoringCpuHelp: "Container-CPU · 100% = ein vollständig genutzter Kern",
  monitoringMemoryHelp: "Containerspeicher einschließlich Java und nativer Speicherbelegung",
  monitoringConnected: "Tick-Messungen verfügbar",
  monitoringOffline: "Server offline oder startet. Keine Tick-Messungen verfügbar.",
  monitoringUnsupported: "Tick-Überwachung wird auf Bedrock nicht unterstützt. Ressourcen bleiben verfügbar.",
  monitoringRconDisabled: "RCON im Tab „Zugriff“ des Servers aktivieren und den Server neu starten, um Tick-Messungen zu erfassen.",
  monitoringSparkMissing: "Der spark-Befehl ist auf diesem Server nicht verfügbar.",
  monitoringUnavailable: "Keine verwertbare spark-Antwort. Der Server startet möglicherweise noch; RCON und spark in der Konsole prüfen.",
  monitoringSource: "Tick-Überwachung",
  monitoringTickHelp: "Bei 20 TPS stehen pro Tick 50 ms zur Verfügung. P95 ist die Dauer, unter der 95% der gemessenen Ticks liegen.",
  monitoringSetup: "Tick-Messungen erfordern auf diesem Server spark. Eine zur Minecraft-Version und zum Loader passende spark-Server-Mod bzw. das Plugin installieren und neu starten.",
  monitoringSparkDocs: "spark-Installationsanleitung",
  monitoringHistory: "Leistungsverlauf",
  monitoringRange: "Zeitraum",
  monitoringFetchError: "Live-Daten konnten nicht geladen werden. Werte erscheinen nach der nächsten erfolgreichen Aktualisierung.",
  monitoringHistoryError: "Verlauf konnte nicht aktualisiert werden. Vorherige Messungen sind möglicherweise veraltet.",
  monitoringP95Help: "95. Perzentil über 10 Sekunden · Referenz: 50 ms bei 20 TPS",
  monitoringPlayersHelp: "Online-Spieler pro Messung",
  monitoringLatest: "Letzte Messung",
  monitoringMinimum: "Minimum",
  monitoringMaximum: "Maximum",
  monitoringReference: "Referenz",
