...
export const pl: Record<TranslationKey, string> = {
  ...
  worldDiscoverDescription: 'Szukaj swiatow w CurseForge albo importuj bezposrednio z URL ZIP/TAR do World Library.',
  ...
  worldDiscoverImported: 'Swiat zaimportowany do World Library',
