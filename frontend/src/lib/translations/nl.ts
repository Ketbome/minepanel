export const pl = {
  ...
  updatedPassword: 'Aktualizowanie hasła...',
  ...
  exceptStopped: 'Chyba że zatrzymane',
  ...
  cpuLimitDesc: 'Maksymalna liczba rdzeni procesora, jaką serwer może obsłużyć use',
  ...
  establishTimeout: 'Ustalony limit czasu (sekundy)',
  ...
  preparationBlocks: 'Przygotowywanie bloków i ustawień...',
  ...
  difficultChanged: 'Zmieniono poziom trudności',
  gameruleChanged: 'Zmieniono regułę gry',
  entityKilled: 'Zabite byty',
  ...
  peaceParadise: 'Spokojny Raj',
  peaceParadiseDesc: 'Relaksujące przetrwanie bez wrogich mobów. Idealny do gry okazjonalnej',
