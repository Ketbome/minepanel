  ...
  private async loadServerConfigFromDockerCompose(serverId: string): Promise<ServerConfig | null> {
    ...
    try {
      ...
      const serverConfig: ServerConfig = {
        ...
        ops: env.OPS ?? '',
        whitelistPlayers: env.WHITELIST ?? '',
        whiteList: edition === 'BEDROCK' ? env.WHITE_LIST === 'true' : env.ENABLE_WHITELIST === 'true' || Boolean(env.WHITELIST),
