...
export const es: Record<TranslationKey, string> = {
  ...
  paPrevious: "Anterior",
  paNext: "Siguiente",
  paFirstSeen: "Primera vez",
  paLastSeen: "Última vez",
  paRecordedTime: "Tiempo registrado",
  paSessions: "Sesiones",
  paIdentityNote: "El historial Java sigue el nombre; el de Bedrock sigue el XUID.",
  paSavedStats: "Estadísticas guardadas del mundo",
  paUpdated: "Actualizado",
  paWorldTime: "Tiempo en el mundo",
  paDeaths: "Muertes",
  paMobKills: "Criaturas eliminadas",
  paPlayerKills: "Jugadores eliminados",
  paBlocksMined: "Bloques minados",
  paStatsNote: "Los totales del mundo proceden del último guardado y son independientes del tiempo de sesión del panel.",
  paStatsUnavailable: "Estadísticas no disponibles. Se requieren estadísticas Java y una entrada coincidente en la caché de jugadores.",
  paJoined: "Entrada",
  paLeft: "Salida / última observación",
  paDuration: "Duración (h:mm:ss)",
  paStatus: "Estado",
  paInterrupted: "Interrumpida",
  paCompleted: "Completada",
  paActive: "Activa",
  paUnknown: "Desconocido",
  paDescription: "Perfiles e historial de sesiones, incluidos jugadores desconectados.",
  paTrackingNote: "Se actualiza cada 30 segundos desde los registros de entrada/salida. Al iniciar se leen hasta 24 horas de registros disponibles. Puede haber lagunas; el tiempo registrado no es el tiempo total histórico.",
  paUnavailable: "Seguimiento no disponible o desactualizado. Estado en línea desconocido.",
  paError: "No se pudo cargar la actividad. Se reintentará automáticamente.",
  paPlayer: "Jugador",
  paOnline: "En línea",
  paOffline: "Desconectado",
  paEmpty: "Todavía no hay sesiones. Los jugadores aparecen tras una entrada registrada.",
  ...
  dangerEggButtonAgain: 'No presionar. Otra vez.',
  dangerEggIntro: 'Te dijeron que no lo presionaras.',
  dangerEggEndTagline: '¿O el comienzo?',
  dangerEggGoalReached: '¡Meta alcanzada!',
  dangerEggAdvEyeSpy: 'Ojo avizor',
  dangerEggAdvEnterEnd: '¿El fin?',
  dangerEggAdvFreeEnd: 'Libera el End',
  dangerEggAdvNextGen: 'La siguiente generación',
  dangerEggChatAdvancement: '{player} ha conseguido el progreso',
  dangerEggChatGoal: '{player} ha alcanzado la meta',
  dangerEggPlayer: 'Jugador',
  dangerEggBossName: 'Dragón del End',
  dangerEggObjectives: 'Objetivos',
  dangerEggObjCrystals: 'Destruye los cristales del End',
  dangerEggObjDragon: 'Derrota al Dragón del End',
  dangerEggObjEgg: 'Atrapa el huevo de dragón',
  dangerEggObjPortal: 'Salta al portal de salida',
  dangerEggHintCrystals: 'Rompe los cristales del End sobre los pilares. Arrastra para mirar alrededor.',
  dangerEggHintHealing: 'Los cristales lo están curando. Rómpelos primero.',
  dangerEggHintPerch: 'El dragón está sobre el portal. ¡Ataca ahora!',
  dangerEggHintEnderman: 'No los mires a los ojos.',
  dangerEggHintEgg: 'El huevo se teletransportó. Inténtalo de nuevo.',
  dangerEggHintPortal: 'El portal de salida está abierto.',
  dangerEggSubEye: 'Ojo de Ender colocado',
  dangerEggSubPortal: 'Se abre el portal del End',
  dangerEggSubTravel: 'Zumbido del portal',
  dangerEggSubLava: 'Burbujeo de lava',
  dangerEggSubGrowl: 'Gruñido del Dragón del End',
  dangerEggSubHurt: 'Dragón del End herido',
  dangerEggSubDeath: 'Muere el Dragón del End',
  dangerEggSubCrystal: 'Explota un cristal del End',
  dangerEggSubEnderman: 'Enderman se teletransporta',
  dangerEggSubEgg: 'Huevo de dragón se teletransporta',
  dangerEggSubXp: 'Tintineo de experiencia',
  dangerEggSubGateway: 'Aparece un acceso del End',
  dangerEggMute: 'Silenciar sonido',
  dangerEggUnmute: 'Activar sonido',
  dangerEggSkip: 'Saltar',
  dangerEggPoem: 'Veo al jugador al que te refieres.\n¿{player}?\nSí. Cuidado. Ha alcanzado un nivel superior. Puede leer nuestros pensamientos.\nNo importa. Cree que somos parte del juego.\nMe gusta este jugador. Jugó bien. No se rindió.\nLe dijeron que no presionara el botón.\nLo presionó de todas formas. Siempre lo hacen. Así es como nos encuentran.\nMantiene mundos en marcha para otros. Lee sus registros mientras duermen.\nReinicia lo que se rompe. Guarda lo que importa. Nunca pidió que le dieran las gracias.\n¿Qué soñó este jugador?\nEste jugador soñó con la luz del sol y los árboles. Con el fuego y el agua. Soñó que creaba. Y soñó que destruía. Soñó que cazaba y que era cazado. Soñó con un refugio.\nY el universo dijo: no estás solo\nY el universo dijo: no estás separado de todo lo demás\nY el universo dijo: eres el universo saboreándose a sí mismo, hablándose a sí mismo, leyendo su propio código\nY el universo dijo: te amo porque eres amor.\nY el juego terminó y el jugador despertó del sueño. Y el jugador comenzó un nuevo sueño. Y el jugador soñó de nuevo, soñó mejor. Y el jugador era el universo. Y el jugador era amor.\nTú eres el jugador.\nDespierta.',
  dangerEggPoemCredit: 'Poema del End de Julian Gough (CC0), abreviado. Cuatro líneas se escribieron para Minepanel.',
  dangerEggPoemHint: 'Mantén Espacio o deja presionado para acelerar',
  ...
  allGamerules: 'Todas las reglas del juego',
  searchGamerules: 'Buscar reglas...',
  gamerulesUnavailable: 'No se pudieron leer las reglas. ¿El servidor terminó de iniciar?',
  gamerulesVanillaOnly: 'Solo se muestran las reglas vanilla: esta versión del servidor no puede listar reglas de mods por RCON.',
  ...
  playersTabDesc: 'Todos los que han entrado a este servidor: estadísticas, logros e inventario, leídos de los archivos del mundo.',
  filterAll: 'Todos',
  noPlayersFound: 'No se encontraron jugadores',
  playerNoDataYet: 'En línea, aún sin datos guardados',
  playersLoadError: 'No se pudieron cargar los jugadores',
  selectPlayer: 'Selecciona un jugador para ver su perfil',
  addToWhitelist: 'Agregar a la whitelist',
  removeFromWhitelist: 'Quitar de la whitelist',
  banned: 'Baneado',
  profile: 'Perfil',
  ...
  spawnPoint: 'Punto de spawn',
  playerDataSavedNote: 'Minecraft guarda los datos del jugador en el autoguardado y al desconectarse, así que los jugadores en línea pueden ir unos minutos atrasados.',
  noStats: 'No hay estadísticas en esta categoría',
  noAdvancements: 'Aún sin logros',
  activity: 'Actividad',
  activityTabDesc: 'Entradas, salidas, chat, muertes, logros y comandos del log del servidor, con búsqueda.',
  activityTracking: 'Registrar actividad',
  activityTrackingDesc: 'Lee el log del servidor para guardar sesiones y una línea de tiempo buscable, incluido el chat. Apagado por defecto; se guarda 30 días.',
  activityDisabled: 'El registro de actividad está apagado en este servidor. Actívalo para empezar a registrar desde ahora.',
  ...
  importHistoryDesc: 'Lee los logs archivados de antes de activar el registro (las fechas salen del nombre del archivo).',
  historyImported: 'Eventos importados',
  eventJoin: 'Entró',
  eventLeave: 'Salió',
  eventChat: 'Chat',
  eventDeath: 'Muerte',
  eventAdvancement: 'Logro',
  eventCommand: 'Comando',
  sessions: 'Sesiones',
  noSessions: 'No hay sesiones registradas. Activa el registro en la pestaña Actividad.',
  totalSessions: 'Sesiones',
  averageSession: 'Sesión promedio',
  longestSession: 'Sesión más larga',
  playStreak: 'Días seguidos',
  playByWeekday: 'Tiempo de juego por día',
  sessionStart: 'Inicio',
  duration: 'Duración',
  chatMessages: 'Chat',
  findItem: 'Buscar un ítem (ej. diamond, una espada renombrada)…',
  findItemDesc: 'Busca en el inventario guardado, el cofre de ender y las shulkers y bundles que lleva cada jugador',
  noItemMatches: 'Nadie tiene ese ítem en su inventario guardado',
  inside: 'dentro de',
  currentInventory: 'Actual',
  autosave: 'Autoguardado',
  beforeDeath: 'antes de morir',
  snapshotBeforeDeath: 'Última foto antes de morir',
  changesSincePrevious: 'Cambios desde la foto anterior',
  noSnapshots: 'Aún no hay fotos (requiere el registro de actividad)',
  ...
  monitoringNativeHelp: "NeoForge estima los TPS a partir del tiempo medio de tick, no contando ticks.",
  monitoringMeanHelp: "Duración media de los ticks recientes de NeoForge",
  monitoringTitle: "Monitorización del servidor",
  monitoringDescription: "Rendimiento del juego y recursos del contenedor. Monitorización nativa de NeoForge para packs CurseForge; spark cuando esté disponible.",
  monitoringCadence: "En vivo: cada 10 s · Historial: cada minuto, conservado 7 días",
  monitoringTpsWindow: "Media de 1 minuto · Objetivo predeterminado: 20",
  monitoringMsptWindow: "Mediana de 10 segundos",
  monitoringCpuHelp: "CPU del contenedor · 100% = un núcleo completo",
  monitoringMemoryHelp: "Memoria del contenedor, incluidas Java y asignaciones nativas",
  monitoringConnected: "Mediciones de ticks disponibles",
  monitoringOffline: "Servidor detenido o iniciándose. Sin mediciones de ticks.",
  monitoringUnsupported: "Los ticks no están disponibles en Bedrock. Los recursos siguen disponibles.",
  monitoringRconDisabled: "Activa RCON en la pestaña Acceso del servidor y reinicia para recopilar mediciones de ticks.",
  monitoringSparkMissing: "El comando spark no está disponible en este servidor.",
  monitoringUnavailable: "Sin respuesta válida de spark. Puede estar iniciándose; comprueba RCON y spark en la consola.",
  monitoringSource: "Monitorización de ticks",
  monitoringTickHelp: "A 20 TPS, cada tick dispone de 50 ms. P95 es la duración por debajo de la que se encuentra el 95% de los ticks.",
  monitoringSetup: "Las mediciones de ticks en este servidor requieren spark. Instala el mod o plugin de servidor de spark compatible con la versión de Minecraft y el cargador, y reinicia.",
  monitoringSparkDocs: "Guía de instalación de spark",
  monitoringHistory: "Historial de rendimiento",
  monitoringRange: "Intervalo",
  monitoringFetchError: "No se pudo cargar la monitorización. Los valores estarán disponibles tras la próxima actualización correcta.",
  monitoringHistoryError: "No se pudo actualizar el historial. Las muestras anteriores pueden estar desactualizadas.",
  monitoringP95Help: "Percentil 95 en 10 segundos · Referencia: 50 ms a 20 TPS",
  monitoringPlayersHelp: "Jugadores conectados en cada muestra",
  monitoringLatest: "Última muestra",
  monitoringMinimum: "Mínimo",
  monitoringMaximum: "Máximo",
  monitoringReference: "Referencia",
