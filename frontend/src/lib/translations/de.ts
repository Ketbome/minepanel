...
export const de: Record<TranslationKey, string> = {
  ...
  serverUnavailableDesc: "Es scheint ein Konfigurationsproblem zu geben. Überprüfen Sie, ob die Backend-URL korrekt eingestellt ist, ob der Server läuft oder ob es ein DNS-Problem gibt.",
  checkingServerStatus: "Verbindung wird überprüft...",
  cannotConnectToServer: "Keine Verbindung zum Server möglich",
  cannotConnectToServerDesc: "Die Anwendung kann keine Verbindung zum Backend-Server herstellen. Bitte überprüfen Sie Ihre Konfiguration.",
  troubleshootingSteps: "Fehlerbehebungsschritte",
  checkBackendUrl: "Backend-URL überprüfen",
  checkBackendUrlDesc: "Stellen Sie sicher, dass die NEXT_PUBLIC_API_URL Umgebungsvariable korrekt konfiguriert ist",
  checkServerRunning: "Serverstatus überprüfen",
  checkServerRunningDesc: "Stellen Sie sicher, dass der Backend-Server läuft und auf dem konfigurierten Port erreichbar ist",
  ...
  serverIdDescription: "Eindeutiger Bezeichner für den Server (nur Buchstaben, Zahlen, Bindestriche und Unterstriche)",
  ...
  // Server Types
  serverVanilla: "Einfacher Minecraft-Server ohne Mods oder Plugins. Ideal für klassisches Survival-Gameplay.",
  serverForge: "Server mit Mod-Unterstützung über Forge. Erfordert die Konfiguration der spezifischen Forge-Version.",
  serverCurseForge: "Installiert automatisch Modpacks von CurseForge. Kann über URL oder Slug des Modpacks konfiguriert werden.",
  serverCurseForgeManual: "Manueller Modus für CurseForge-Modpacks. Verwendet vorgeladene ZIP-Dateien. Veraltete Funktion, wir empfehlen CurseForge Modpack.",
  ...
  deleteConfirmDesc: "Diese Aktion kann nicht rückgängig gemacht werden. Alle Welten, Konfigurationen und gespeicherten Serverdaten werden gelöscht.",
  ...
  serverRunningWarningDesc: "Die Konfiguration kann nicht bearbeitet werden, während der Server läuft. Stoppen Sie den Server, um Änderungen vorzunehmen.",
  ...
  seedDescription: "Welt-Seed für die Weltgenerierung. Wenn Sie eine negative Zahl verwenden, stellen Sie sicher, dass Sie sie in Anführungszeichen setzen.",
  levelType: "Welttyp",
  ...
  generateStructuresDescription: "Definiert, ob Strukturen wie Dörfer, Tempel usw. generiert werden",
  ...
  viewDistanceDesc: "Bestimmt, wie viele Chunks um jeden Spieler geladen werden. Niedrigere Werte verbessern die Leistung.",
  chunks: "Chunks",
  simulationDistance: "Simulationsdistanz",
  simulationDistanceDesc: "Bestimmt, wie weit der Server aktualisiert (Mobs, Pflanzen usw.). Kann niedriger als die Sichtweite sein.",
  enableCommandBlocks: "Befehlsblöcke aktivieren",
  enableCommandBlocksDesc: "Ermöglicht die Verwendung von Befehlsblöcken, die die Leistung beeinträchtigen können, wenn sie übermäßig verwendet werden.",
  ...
  serverPortWarning: "Dieser Port muss sich von anderen laufenden Servern unterscheiden, um Konflikte zu vermeiden.",
  ...
  onlineModeDesc: "Wenn aktiviert, überprüft der Server, ob Spieler bei Mojang authentifiziert sind. Es wird empfohlen, dies aktiviert zu lassen, um Benutzer mit gefälschten Namen zu verhindern.",
  preventProxyConnections: "Proxy-Verbindungen verhindern",
  preventProxyConnectionsDesc: "Wenn aktiviert, versucht der Server, Verbindungen über Proxys/VPNs zu erkennen und zu blockieren.",
  ...
  allowFlightDesc: "Spielern das Fliegen erlauben (wenn sie den Kreativmodus oder Flug-Mods aktiviert haben)",
  ...
  dockerVolumesHelp: "Docker-Volume-Mappings (eines pro Zeile, Format: lokaler-pfad:container-pfad)",
  ...
  extraPortsUseful: "Zusätzliche Ports sind nützlich für Plugins, die spezifische Verbindungen benötigen",
  ...
  environmentVarsHelp: "Zusätzliche Umgebungsvariablen für den Container (eine pro Zeile, Format: SCHLÜSSEL=WERT)",
  variableName: "Variablenname",
  variableValue: "Wert",

  // Docker Labels
  dockerLabels: "Docker-Labels",
  dockerLabelsDesc: "Benutzerdefinierte Labels für den Container, nützlich für Reverse-Proxies wie Traefik oder Caddy",
  dockerLabelsHelp: "Container-Labels (eines pro Zeile, Format: schlüssel=wert). Nützlich für Traefik, Caddy, nginx-proxy, etc.",
  ...
  backupExcludesDesc: "Muster von Dateien, die vom Backup ausgeschlossen werden sollen (durch Kommas getrennt)",
  ...
  pauseIfNoPlayersDesc: "Keine automatischen Backups durchführen, wenn keine Spieler verbunden sind",

  // ===========================
  // RESOURCES TAB
  // ===========================
  serverResources: "Server-Ressourcen",
  serverResourcesDesc: "Konfigurieren Sie Speicher, CPU und andere Ressourcenbeschränkungen für Ihren Server",
  ...
  aikarFlagsTooltip: "Aikar hat Forschungen durchgeführt, um die optimalen JVM-Flags für GC-Tuning zu finden, was umso wichtiger ist, je mehr Benutzer gleichzeitig verbunden sind.",
  ...
  systemPropertiesDdDesc: "Liste von Systemeigenschaften durch Kommas getrennt (name=wert oder name:wert)",
  ...
  autoStopTooltip: "Stoppt den Server automatisch, wenn für die angegebene Zeit keine Spieler online sind",
  cannotUseWithAutoPause: "Kann nicht zusammen mit Auto-Pause verwendet werden",
  initialTimeout: "Anfängliches Timeout (Sekunden)",
  autoStopTimeoutInitDesc: "Anfängliche Wartezeit zum Stoppen des Servers, wenn keine Spieler online sind",
  ...
  autoPauseTooltip: "Pausiert den Server automatisch, wenn für die angegebene Zeit keine Spieler online sind",
  ...
  commandsInfo: 'Befehle werden ohne das anfängliche "/" Symbol gesendet. Verwenden Sie Tab zum Autovervollständigen der vorgeschlagenen Befehle.',
  ...
  rconNotConfiguredDesc: "Konfigurieren Sie RCON-Port und Passwort im Tab Allgemeine Einstellungen, um Befehle zu verwenden",
  commands: "Befehle",
  enterACommandToExecute: "Befehl zum Ausführen eingeben",
  rconPortNotConfigured: "RCON-Port nicht konfiguriert",
  rconPortNotConfiguredDesc: "Konfigurieren Sie den RCON-Port im Tab Allgemeine Einstellungen, um Befehle zu verwenden (Passwort ist optional)",
  ...
  pluginsSelectServerType: 'Wählen Sie Spigot, Paper oder Bukkit als Servertyp im Tab "Servertyp", um Plugins zu konfigurieren.',
  pluginsAutoDownload: "Auto-Download von Spiget",
  pluginsAutoDownloadDesc: "Automatische Plugin-Downloads von SpigotMC über die Spiget-API. ZIP-Dateien werden automatisch im Plugins-Ordner entpackt.",
  pluginsManualInfo: "Um Plugins manuell hinzuzufügen (JAR-Dateien), verwenden Sie den Dateibrowser, um sie in den /plugins-Ordner des Servers hochzuladen.",
  ...
  pluginsSpigetWarning: "⚠️ Einige Plugins wie EssentialsX erlauben keine automatisierten Downloads.",
  ...
  fileBrowserTipDesc: "Sie können Konfigurationsdateien bearbeiten, Dateien hoch-/herunterladen und Berechtigungen direkt von hier aus verwalten.",
  ...
  foliaWarning: "Folia ist experimentell und viele Plugins funktionieren möglicherweise aufgrund von Multi-Threading-Änderungen nicht korrekt.",
  ...
  skipDownloadDefaultsDesc: "Überprüfung auf Standard-Paper/Bukkit/Spigot-Konfigurationsdateien zum Herunterladen überspringen",
  ...
  modsSelectServerType: 'Wählen Sie Forge oder CurseForge als Servertyp im Tab "Servertyp", um Mods zu konfigurieren.',
  ...
  serverFabric: "Server mit Unterstützung für Fabric-Mods. Eine leichtgewichtige Modding-Plattform als Alternative zu Forge.",
  ...
  modrinthProjectsHelp: "Komma- oder zeilengetrennte Liste von Projekt-Slugs/IDs. Formate: 'fabric-api' (neueste), 'fabric-api:0.119.2' (Version), 'fabric-api:beta' (Release-Typ), 'datapack:terralith', '@/path/to/file.txt' (Auflistung). Siehe Dokumentation für alle Formate.",
  ...
  modrinthDependenciesHelp: "Ob erforderliche und/oder optionale Abhängigkeiten heruntergeladen werden sollen",
  modrinthVersionType: "Standard-Versionstyp",
  modrinthVersionTypeHelp: "Der Versionstyp für die Auswahl der neuesten Version (release, beta oder alpha)",
  ...
  manualCurseForgeDeprecated: 'Diese manuelle Methode für CurseForge ist veraltet. Wir empfehlen die Verwendung von "CurseForge Modpack" (AUTO_CURSEFORGE) für neue Installationen. Dieser Modus erfordert, dass Sie die Modpack-Dateien manuell auf den Server hochladen.',
  ...
  useModpackStartScriptDesc: "Wenn deaktiviert, wird das im Modpack enthaltene Startskript vermieden und die Standard-Serverlogik verwendet",
  ftbLegacyJavaFixer: "FTB Legacy Java Fixer",
  ftbLegacyJavaFixerDesc: 'Fix für Modpacks aktivieren, die mit "unable to launch forgemodloader" fehlschlagen',
  ...
  cfApiKeyRequired: "Für die ordnungsgemäße Nutzung der CurseForge-Funktionalität ist ein API-Schlüssel erforderlich. Der API-Schlüssel ist notwendig, um private oder eingeschränkte Modpacks herunterzuladen.",
  ...
  fileIdHelp: "Numerische ID der spezifischen Datei zum Herunterladen. Wenn nicht angegeben, wird die neueste Version verwendet.",
  fileIdDesc: "Spezifische Datei-ID zum Herunterladen. Wenn leer gelassen, wird die neueste Version verwendet.",

  filePattern: "Dateimuster (CF_FILENAME_MATCHER)",
  filePatternHelp: "Geben Sie einen Teilstring an, um die gewünschte Datei im /modpacks-Ordner zu finden.",
  filePatternDesc: "Muster zum Finden der Modpack-Datei im /modpacks-Ordner",

  cfApiKey: "CurseForge API-Schlüssel (CF_API_KEY)",
  cfApiKeyHelp: "CurseForge API-Schlüssel (Eternal), erforderlich zum Herunterladen einiger Modpacks.",
  cfApiKeyDesc: "API-Schlüssel zum Herunterladen eingeschränkter Modpacks (für die meisten Modpacks erforderlich)",

  // CurseForge Advanced Options
  advancedOptions: "Erweiterte Optionen",
  synchronizeCurseForge: "CurseForge synchronisieren (CF_FORCE_SYNCHRONIZE)",
  synchronizeCurseForgeDesc: "Modpack-Updates automatisch synchronisieren, wenn der Server neu startet",
  parallelDownloads: "Parallele Downloads (CF_PARALLEL_DOWNLOADS)",
  parallelDownloadsHelp: "Anzahl der Mod-Downloads, die parallel durchgeführt werden. Standardwert: 4",
  ...
  skipExistingFilesDesc: "Wenn aktiviert, werden Dateien, die bereits im Datenverzeichnis existieren, nicht ersetzt",
  ...
  curseforgeFilesHelp: "Einzelne Mods automatisch von CurseForge herunterladen. Formate: 'jei' (neueste), 'jei:4593548' (Datei-ID), 'jei@10.2.1' (Version), vollständige URL oder '@/path/to/file.txt' (Auflistung). Automatisch verwaltet - entfernte Einträge werden bereinigt. Siehe Dokumentation für alle Formate.",
  curseforgeFilesDesc: "Komma- oder zeilengetrennte Liste (z.B.: jei, geckolib:4593548, aquaculture@1.0.0)",
  forceIncludeMods: "Client-Mods erzwingen (CF_FORCE_INCLUDE_MODS)",
  forceIncludeModsHelp: "Erzwingt die Aufnahme von Mods, die fälschlicherweise als nur für Client markiert sind. Lädt KEINE zusätzlichen Mods herunter - überschreibt nur Client-Only-Tags für Mods, die bereits im Modpack oder in CURSEFORGE_FILES enthalten sind.",
  forceIncludeModsDesc: "Projekt-Slugs oder IDs zum erzwungenen Einschließen trotz Client-Only-Tag (komma- oder leerzeichengetrennt)",
  excludeMods: "Mods ausschließen (CF_EXCLUDE_MODS)",
  excludeModsHelp: "Liste der Mods (durch Leerzeichen oder Zeilen getrennt), die vom Modpack ausgeschlossen werden (IDs oder Slugs).",
  excludeModsDesc: "Liste der Mods, die vom Modpack ausgeschlossen werden (IDs oder Slugs, eine pro Zeile, unterstützt Glob-Muster)",

  // ===========================
  // UI COMPONENTS
  // ===========================
  tip: "Tipp:",
  configureServerTip: "Konfigurieren Sie diesen Server, indem Sie die Parameter in den folgenden Tabs anpassen.",
  ...
  loadMore: "Mehr laden",
  curseforgeApiKeyNotConfigured: "CurseForge API-Schlüssel ist nicht konfiguriert. Bitte fügen Sie ihn in den Einstellungen hinzu, um diese Funktion zu nutzen.",
