...
export const de: Record<TranslationKey, string> = {
  ...
  monitoringRconDisabled: "RCON in den Netzwerkeinstellungen aktivieren und den Server neu starten.",
  ...
  monitoringSetup: "Bei NeoForge-basierten Modpacks prüfen, ob das Pack spark enthält. Falls nicht, eine zur Minecraft-Version und zum Loader passende Server-Mod installieren und neu starten.",
