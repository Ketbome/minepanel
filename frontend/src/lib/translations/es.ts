...
export const es: Record<TranslationKey, string> = {
  ...
  rconNotConfiguredDesc: "Configura el puerto y contraseña RCON en la pestaña de configuración General para usar comandos",
  commands: "Comandos",
  enterACommandToExecute: "Ingresa un comando para ejecutar",
  rconPortNotConfigured: "El puerto RCON no está configurado",
  rconPortNotConfiguredDesc: "Configura el puerto RCON en la pestaña de configuración General para usar comandos (la contraseña es opcional)",
  ...
  fileBrowserTipDesc: "Puedes editar archivos de configuración, subir/descargar archivos y gestionar permisos directamente desde aquí.",
  ...
  quickCreateDesc: "Crea un servidor vacío con configuración por defecto. Puedes configurar todo después.",
  templateSelected: "Plantilla seleccionada",
  vanillaSurvival: "Vanilla Supervivencia",
  vanillaSurvivalDesc: "La experiencia clásica de Minecraft. Modo supervivencia con dificultad normal.",
  vanillaCreative: "Vanilla Creativo",
  vanillaCreativeDesc: "Creatividad ilimitada. Construye libremente con todos los bloques y sin monstruos.",
  ...
  paperPerformanceDesc: "Servidor Paper optimizado con flags Aikar. Ideal para servidores públicos.",
  skyblock: "SkyBlock",
