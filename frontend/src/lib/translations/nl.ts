...
export const nl: Record<TranslationKey, string> = {
  ...
  rconNotConfiguredDesc: "Configureer RCON poort en wachtwoord in het tabblad Algemene instellingen om commando's te gebruiken",
  commands: "Commando's",
  enterACommandToExecute: "Voer een commando in om uit te voeren",
  rconPortNotConfigured: "RCON poort niet geconfigureerd",
  rconPortNotConfiguredDesc: "Configureer RCON poort in het tabblad Algemene instellingen om commando's te gebruiken (wachtwoord is optioneel)",
  ...
  fileBrowserTipDesc: "Je kunt configuratiebestanden bewerken, bestanden uploaden/downloaden en machtigingen direct vanaf hier beheren.",
  ...
  quickCreateDesc: "Maak een lege server met standaardinstellingen. Je kunt alles later configureren.",
  templateSelected: "Sjabloon geselecteerd",
  vanillaSurvival: "Vanilla Survival",
  vanillaSurvivalDesc: "De klassieke Minecraft-ervaring. Overlevingsmodus met normale moeilijkheid.",
  ...
  paperPerformanceDesc: "Geoptimaliseerde Paper-server met Aikar-vlaggen. Ideaal voor openbare servers.",
  skyblock: "SkyBlock",
