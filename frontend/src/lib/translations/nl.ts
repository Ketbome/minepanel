...
export const nl: Record<TranslationKey, string> = {
  ...
  monitoringRconDisabled: "Schakel RCON in bij de netwerkinstellingen en herstart de server.",
  ...
  monitoringSetup: "Controleer bij NeoForge-modpacks of het pack spark bevat. Installeer zo nodig de servermod voor de juiste Minecraft-versie en loader en herstart.",
