export const en = {
  ...
  monitoringDescription: "Game performance and container resources, together. Native NeoForge monitoring for CurseForge modpacks such as ATM10; spark where available.",
  ...
  monitoringSetup: "For ATM10 / NeoForge, check that the pack includes spark. If missing, install a server mod matching the Minecraft version and loader, then restart.",
