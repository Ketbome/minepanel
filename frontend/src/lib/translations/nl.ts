...
export const nl: Record<TranslationKey, string> = {
  ...
  worldDiscoverDescription: 'Zoek werelden op CurseForge of importeer direct via een ZIP/TAR URL naar de World Library.',
  ...
  worldDiscoverImported: 'Wereld geimporteerd in de World Library',
