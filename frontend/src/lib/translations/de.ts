...
export const de: Record<TranslationKey, string> = {
  ...
  monitoringDescription: "Spielleistung und Containerressourcen. Native NeoForge-Überwachung für CurseForge-Modpacks wie ATM10; spark, sofern verfügbar.",
  ...
  monitoringSetup: "Bei ATM10 / NeoForge prüfen, ob das Pack spark enthält. Falls nicht, eine zur Minecraft-Version und zum Loader passende Server-Mod installieren und neu starten.",
