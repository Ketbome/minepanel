export const en = {
  ...
  rconNotConfiguredDesc: "Configure RCON port and password in the General settings tab to use commands",
  commands: "Commands",
  enterACommandToExecute: "Enter a command to execute",
  rconPortNotConfigured: "RCON port not configured",
  rconPortNotConfiguredDesc: "Configure RCON port in the General settings tab to use commands (password is optional)",
  ...
  fileBrowserTipDesc: "You can edit configuration files, upload/download files, and manage permissions directly from here.",
