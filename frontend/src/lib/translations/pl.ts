...
export const pl: Record<TranslationKey, string> = {
  ...
  paNext: "Następna",
  paFirstSeen: "Pierwsza obecność",
  paLastSeen: "Ostatnia obecność",
  paRecordedTime: "Zarejestrowany czas gry",
  paSessions: "Sesje",
  paIdentityNote: "Historia Java jest powiązana z nazwą gracza, a Bedrock z XUID.",
  paSavedStats: "Zapisane statystyki świata",
  paUpdated: "Aktualizacja",
  paWorldTime: "Czas gry w świecie",
  paDeaths: "Zgony",
  paMobKills: "Zabite stworzenia",
  paPlayerKills: "Zabici gracze",
  paBlocksMined: "Wykopane bloki",
  paStatsNote: "Sumy świata pochodzą z ostatniego zapisu i są niezależne od czasu sesji w panelu.",
  paStatsUnavailable: "Statystyki niedostępne. Wymagane są statystyki Java i zgodny wpis w pamięci graczy.",
  paJoined: "Wejście",
  paLeft: "Wyjście / ostatnia obserwacja",
  paDuration: "Czas (g:mm:ss)",
  paStatus: "Stan",
  paInterrupted: "Przerwana",
  paCompleted: "Zakończona",
  paActive: "Aktywna",
  paUnknown: "Nieznany",
  paDescription: "Profile graczy i historia sesji, także graczy offline.",
  paTrackingNote: "Aktualizacja co 30 sekund z logów wejść i wyjść. Przy pierwszym uruchomieniu odczytywane są dostępne logi z ostatnich 24 godzin. Brakujące logi mogą tworzyć luki; zapisany czas nie jest całkowitym historycznym czasem gry.",
  paUnavailable: "Śledzenie niedostępne lub nieaktualne. Stan online nieznany.",
  paError: "Nie udało się wczytać aktywności. Próba zostanie ponowiona automatycznie.",
  paPlayer: "Gracz",
  paOnline: "Online",
  paOffline: "Offline",
  paEmpty: "Brak sesji. Gracze pojawią się po zarejestrowanym wejściu.",
  ...
  dangerEggButtonAgain: 'Nie naciskaj. Znowu.',
  dangerEggIntro: 'Mówiono ci, żebyś tego nie naciskał.',
  dangerEggEndTagline: 'Czy może początek?',
  dangerEggGoalReached: 'Cel osiągnięty!',
  dangerEggAdvEyeSpy: 'Szpiegowskie oko',
  dangerEggAdvEnterEnd: 'Kres?',
  dangerEggAdvFreeEnd: 'Uwolnij Kres',
  dangerEggAdvNextGen: 'Następne pokolenie',
  dangerEggChatAdvancement: '{player} osiągnął postęp',
  dangerEggChatGoal: '{player} osiągnął cel',
  dangerEggPlayer: 'Gracz',
  dangerEggBossName: 'Smok Kresu',
  dangerEggObjectives: 'Cele',
  dangerEggObjCrystals: 'Zniszcz kryształy Kresu',
  dangerEggObjDragon: 'Pokonaj Smoka Kresu',
  dangerEggObjEgg: 'Złap smocze jajo',
  dangerEggObjPortal: 'Wskocz do portalu powrotnego',
  dangerEggHintCrystals: 'Rozbij kryształy Kresu na filarach. Przeciągnij, aby się rozejrzeć.',
  dangerEggHintHealing: 'Kryształy go leczą. Najpierw je rozbij.',
  dangerEggHintPerch: 'Smok unosi się nad portalem. Uderzaj teraz!',
  dangerEggHintEnderman: 'Nie patrz im w oczy.',
  dangerEggHintEgg: 'Jajo się teleportowało. Spróbuj ponownie.',
  dangerEggHintPortal: 'Portal powrotny jest otwarty.',
  dangerEggSubEye: 'Oko Kresu umieszczone',
  dangerEggSubPortal: 'Portal Kresu się otwiera',
  dangerEggSubTravel: 'Portal szumi',
  dangerEggSubLava: 'Lawa bulgocze',
  dangerEggSubGrowl: 'Smok Kresu warczy',
  dangerEggSubHurt: 'Smok Kresu zraniony',
  dangerEggSubDeath: 'Smok Kresu umiera',
  dangerEggSubCrystal: 'Kryształ Kresu wybucha',
  dangerEggSubEnderman: 'Enderman się teleportuje',
  dangerEggSubEgg: 'Smocze jajo się teleportuje',
  dangerEggSubXp: 'Kula doświadczenia dzwoni',
  dangerEggSubGateway: 'Pojawia się brama Kresu',
  dangerEggMute: 'Wycisz dźwięk',
  dangerEggUnmute: 'Włącz dźwięk',
  dangerEggSkip: 'Pomiń',
  dangerEggPoem: 'Widzę gracza, o którym mówisz.\n{player}?\nTak. Uważaj. Osiągnął teraz wyższy poziom. Potrafi czytać nasze myśli.\nTo nie ma znaczenia. Myśli, że jesteśmy częścią gry.\nLubię tego gracza. Grał dobrze. Nie poddał się.\nPowiedziano mu, żeby nie naciskał przycisku.\nI tak go nacisnął. Zawsze to robią. Tak nas znajdują.\nUtrzymuje światy innych przy życiu. Czyta ich logi, kiedy śpią.\nUruchamia ponownie to, co się psuje. Chroni to, co ważne. Nigdy nie prosił o podziękowania.\nO czym śnił ten gracz?\nTen gracz śnił o słońcu i drzewach. O ogniu i wodzie. Śnił, że tworzy. I śnił, że niszczy. Śnił, że poluje i że na niego polują. Śnił o schronieniu.\nA wszechświat powiedział: nie jesteś sam\nA wszechświat powiedział: nie jesteś oddzielony od wszystkiego innego\nA wszechświat powiedział: jesteś wszechświatem, który sam siebie smakuje, sam do siebie mówi, czyta własny kod\nA wszechświat powiedział: kocham cię, bo jesteś miłością.\nI gra się skończyła, a gracz obudził się ze snu. I gracz zaczął nowy sen. I gracz znów śnił, śnił lepiej. I gracz był wszechświatem. I gracz był miłością.\nTy jesteś graczem.\nObudź się.',
  dangerEggPoemCredit: 'Poemat Kresu autorstwa Juliana Gougha (CC0), skrócony. Cztery wersy napisano dla Minepanel.',
  dangerEggPoemHint: 'Przytrzymaj spację lub palec, aby przyspieszyć',
  ...
  // Compose Snippets
  composeSnippets: 'Fragmenty Compose',
  composeSnippetsDesc: 'Surowy YAML docker-compose scalany z wygenerowanym plikiem',
  composeSnippetsWarning:
    'Opcja zaawansowana i delikatna. Każdy fragment jest scalany z wygenerowanym plikiem docker-compose.yml, więc błąd lub zmiana klucza zarządzanego przez panel może uniemożliwić start serwera. Tylko administratorzy mogą to edytować.',
  composeSnippetsHelp:
    'Każdy fragment to YAML scalany w wybranym miejscu. Mapy są scalane, listy uzupełniane, a każda inna wartość zastępuje wartość panelu.',
  composeSnippetTargetRoot: 'Najwyższy poziom (networks, volumes, ...)',
  composeSnippetTargetServices: 'Usługi (dodaj kolejne usługi)',
  composeSnippetTargetMc: 'Usługa Minecraft',
  addComposeSnippet: 'Dodaj fragment',
  removeComposeSnippet: 'Usuń fragment',
  ...
  playersTabDesc: 'Wszyscy, którzy dołączyli do tego serwera: statystyki, osiągnięcia i ekwipunek, odczytane z plików świata.',
  filterAll: 'Wszyscy',
  noPlayersFound: 'Nie znaleziono graczy',
  playerNoDataYet: 'Online, brak zapisanych danych',
  playersLoadError: 'Nie udało się wczytać graczy',
  selectPlayer: 'Wybierz gracza, aby zobaczyć profil',
  addToWhitelist: 'Dodaj do whitelisty',
  removeFromWhitelist: 'Usuń z whitelisty',
  banned: 'Zbanowany',
  profile: 'Profil',
  ...
  armor: 'Zbroja',
  offhand: 'Druga ręka',
  enderChest: 'Skrzynia Kresu',
  itemDurability: 'Wytrzymałość',
  playerHealth: 'Zdrowie',
  playerHunger: 'Głód',
  activeEffects: 'Aktywne efekty',
  noActiveEffects: 'Brak aktywnych efektów',
  playTime: 'Czas gry',
  deaths: 'Śmierci',
  mobKills: 'Zabite moby',
  playerKills: 'Zabójstwa PvP',
  distanceTraveled: 'Dystans',
  blocksMined: 'Wykopane bloki',
  lastSeen: 'Ostatnio widziany',
  never: 'Nigdy',
  lastPosition: 'Ostatnia pozycja',
  spawnPoint: 'Punkt odrodzenia',
  playerDataSavedNote: 'Minecraft zapisuje dane gracza przy autozapisie i wylogowaniu, więc gracze online mogą być kilka minut w tyle.',
  noStats: 'Brak statystyk w tej kategorii',
  noAdvancements: 'Brak osiągnięć',
  activity: 'Aktywność',
  activityTabDesc: 'Wejścia, wyjścia, czat, śmierci, osiągnięcia i komendy z logu serwera, z wyszukiwaniem.',
  activityTracking: 'Rejestruj aktywność',
  activityTrackingDesc: 'Czyta log serwera, aby zapisywać sesje i przeszukiwalną oś czasu, łącznie z czatem. Domyślnie wyłączone; przechowywane 30 dni.',
  activityDisabled: 'Rejestrowanie aktywności jest wyłączone na tym serwerze. Włącz je, aby zacząć zapisywać od teraz.',
  activityLoadError: 'Nie udało się wczytać aktywności',
  noActivity: 'Brak zarejestrowanej aktywności',
  importHistory: 'Importuj historię',
  importHistoryDesc: 'Czyta zarchiwizowane logi sprzed włączenia (daty pochodzą z nazw archiwów).',
  historyImported: 'Zaimportowane zdarzenia',
  eventJoin: 'Dołączył',
  eventLeave: 'Wyszedł',
  eventChat: 'Czat',
  eventDeath: 'Śmierć',
  eventAdvancement: 'Osiągnięcie',
  eventCommand: 'Komenda',
  sessions: 'Sesje',
  noSessions: 'Brak sesji. Włącz rejestrowanie aktywności w zakładce Aktywność.',
  totalSessions: 'Sesje',
  averageSession: 'Średnia sesja',
  longestSession: 'Najdłuższa sesja',
  playStreak: 'Dni z rzędu',
  playByWeekday: 'Czas gry wg dnia tygodnia',
  sessionStart: 'Start',
  duration: 'Czas trwania',
  chatMessages: 'Czat',
  findItem: 'Szukaj przedmiotu (np. diamond, miecz ze zmienioną nazwą)…',
  findItemDesc: 'Przeszukuje zapisany ekwipunek, skrzynię Kresu oraz noszone shulkery i worki każdego gracza',
  noItemMatches: 'Nikt nie ma tego przedmiotu w zapisanym ekwipunku',
  inside: 'w',
  currentInventory: 'Aktualny',
  autosave: 'Autozapis',
  beforeDeath: 'przed śmiercią',
  snapshotBeforeDeath: 'Ostatni zapis przed śmiercią',
  changesSincePrevious: 'Zmiany od poprzedniego zapisu',
  noSnapshots: 'Brak zapisów (wymaga rejestrowania aktywności)',
  ...
  metrics: 'Metryki',
  tasks: 'Zadania',
  monitoringEstimatedTps: "Szacowane TPS",
  monitoringNativeHelp: "NeoForge szacuje TPS na podstawie średniego czasu ticka, bez zliczania ticków.",
  monitoringMeanHelp: "Średni czas ostatnich ticków NeoForge",
  monitoringTitle: "Monitorowanie serwera",
  monitoringDescription: "Wydajność gry i zasoby kontenera. Natywne monitorowanie NeoForge dla paczek CurseForge; spark, gdy dostępny.",
  monitoringCadence: "Na żywo: co 10 s · Historia: co minutę, przechowywana 7 dni",
  monitoringTpsWindow: "Średnia z 1 minuty · Domyślny cel: 20",
  monitoringMsptWindow: "Mediana z 10 sekund",
  monitoringCpuHelp: "CPU kontenera · 100% = jeden w pełni obciążony rdzeń",
  monitoringMemoryHelp: "Pamięć kontenera, w tym Java i alokacje natywne",
  monitoringConnected: "Pomiary ticków dostępne",
  monitoringOffline: "Serwer wyłączony lub uruchamiany. Pomiary ticków niedostępne.",
  monitoringUnsupported: "Monitorowanie ticków nie jest obsługiwane w Bedrock. Zasoby pozostają dostępne.",
  monitoringRconDisabled: "Włącz RCON w zakładce Dostęp serwera i uruchom go ponownie, aby zbierać pomiary ticków.",
  monitoringSparkMissing: "Polecenie spark jest niedostępne na tym serwerze.",
  monitoringUnavailable: "Brak poprawnej odpowiedzi spark. Serwer może się uruchamiać; sprawdź RCON i spark w konsoli.",
  monitoringSource: "Monitorowanie ticków",
  monitoringTickHelp: "Przy 20 TPS tick ma budżet 50 ms. P95 oznacza czas, poniżej którego mieści się 95% zmierzonych ticków.",
  monitoringSetup: "Pomiary ticków na tym serwerze wymagają spark. Zainstaluj serwerowy mod lub plugin spark zgodny z wersją Minecraft i loaderem, a następnie uruchom serwer ponownie.",
  monitoringSparkDocs: "Instrukcja konfiguracji spark",
  monitoringHistory: "Historia wydajności",
  monitoringRange: "Zakres czasu",
  monitoringFetchError: "Nie udało się wczytać monitorowania. Wartości pojawią się po następnym udanym odświeżeniu.",
  monitoringHistoryError: "Nie udało się odświeżyć historii. Poprzednie pomiary mogą być nieaktualne.",
  monitoringP95Help: "95. percentyl z 10 sekund · Odniesienie: 50 ms przy 20 TPS",
  monitoringPlayersHelp: "Gracze online przy każdym pomiarze",
  monitoringLatest: "Ostatnia próbka",
  monitoringMinimum: "Minimum",
  monitoringMaximum: "Maksimum",
  monitoringReference: "Odniesienie",
