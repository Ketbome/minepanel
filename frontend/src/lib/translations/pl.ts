...
export const pl: Record<TranslationKey, string> = {
  ...
  monitoringRconDisabled: "Włącz RCON w ustawieniach sieci serwera i uruchom go ponownie.",
  ...
  monitoringSetup: "W paczkach opartych na NeoForge sprawdź, czy paczka zawiera spark. Jeśli nie, zainstaluj mod serwerowy zgodny z wersją Minecraft i loaderem, a następnie uruchom serwer ponownie.",
