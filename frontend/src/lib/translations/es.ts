...
export const es: Record<TranslationKey, string> = {
  ...
  worldDiscoverDescription: 'Busca mundos en CurseForge o importa directamente desde una URL ZIP/TAR a World Library.',
  ...
  worldDiscoverImported: 'Mundo importado en World Library',
